              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Register New System User</h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     <button class="btn btn-icon icon-left btn-primary" type="submit" name="register"><i class="fa fa-plus"></i> Register System User</button>
